		...
		<div class="right-content">
			<div id="Class-Overview" class="tab-content class-overview">
				<div class="row place-list">
					...
					<input type="hidden" id="subAsmId" value=""> <input
						type="hidden" id="asmDueInSecond" value="${due}">
					<table class="table table-striped table-hover">
						<tbody>
							...
							<tr>
								<td><b>BRIEF</b></td>
								<td><a href="${assignment.asmBrief}"><i
										class="fas fa-briefcase"> Brief </i></a></td>
							</tr>
							<tr>
								<td><b>DUE</b></td>
					...
					<div id="buttonUpload">
						<button onclick="showFormEdit()"
							style="font-size: 16px; font-weight: 550; background: #009688; color: #fff; width: 150px; height: 40px; border-radius: 15px; border: none;">Edit
							Submission</button>
					</div>
					<div id="formButtonEdit">
						<form id="formEdit">
							<input id="fileEdit" required type="file" name="fileSubmit"
					...
					<div id="formUpload">
						...
						<form id="formSubmit">
							<input id="fileSubmit" required type="file" name="fileSubmit"
								formenctype="multipart/form-data" />
							<button type="submit">Submit File</button>
						</form>
					</div>
				...
				<script type="text/javascript">
					...
					function getSubmissionInfo() {
						$
								.ajax({
									type : "GET",
									url : "http://localhost:8083/cms-btec/trainee-api/submission-info?asmId="
											+ $("#asmId").val(),
									success : function(res) {
										if (res == "") {
											$("#formUpload").show()
										} else {
											if ($("#asmDueInSecond").val()
													- res.modifiedDate < 0) {
												$("#submit-status")
														.text(
																"Overdue You Failed Bro :(")
											} else {
												console.log(res)
												$("#submit-time")
														.text(
